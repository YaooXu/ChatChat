...
public:
    ...
    void setupUi(QDialog *addfri_interface)
    {
        ...
        comboBox->setGeometry(QRect(120, 170, 86, 25));
        ...
        lineEdit->setGeometry(QRect(110, 100, 113, 25));
    ...
    void retranslateUi(QDialog *addfri_interface)
    {
        ...
        pushButton->setText(QApplication::translate("addfri_interface", "PushButton", nullptr));
    } // retranslateUi
