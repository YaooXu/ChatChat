    ...
    if (result == NULL) {
        ...
        for (int i = 0; i < num; i++) {
            printf("%s, %d,%s, %d, %s, %s, %s, %s, %s, %s\n",
                   pUser_info[i].ID, pUser_info[i].photo_id,
                   pUser_info[i].name, pUser_info[i].sex_id,
                   pUser_info[i].tel, pUser_info[i].question,
                   pUser_info[i].answer, pUser_info[i].description,
